...
AUTHORIZATION_RECORD_ID=5342161510
SOURCE_IMPLEMENTATION_REVIEW_RESULT_RECORD_ID=5342117978
CORRECTION_SCOPE=CONTRACT_COMPATIBILITY_ONLY
...
MIMO_RESPONSES_REASONING_EFFORT=none
PROVIDER_REASONING_CONTENT_PERSISTED=NO
PROVIDER_REASONING_CONTENT_REPLAYED=NO
PROVIDER_CONVERSATION_STATE_ALLOWED=NO

BACKGROUND_MODE=FORBIDDEN
PREVIOUS_RESPONSE_ID_ALLOWED=NO
CONTEXT_MANAGEMENT_ALLOWED=NO
CONVERSATION_STATE=FORBIDDEN
PROVIDER_STATE_FIELDS_EMITTED=NONE

MIMO_RESPONSES_TEMPERATURE_MIN=0.0
MIMO_RESPONSES_TEMPERATURE_MAX=1.5
MIMO_RESPONSES_DEFAULT_TEMPERATURE=0.0
MIMO_CUSTOM_TEMPERATURE_ALLOWED=YES
MIMO_CUSTOM_TEMPERATURE_REQUIRES_REASONING_EFFORT=none

OPENAI_RESPONSES_PARSE_PYDANTIC_SERIALIZATION=text.format.type=json_schema;strict=true
OPENAI_RESPONSES_PARSE_PYDANTIC_WIRE_AUTHORIZED=NO
OPENAI_JSON_SCHEMA_WIRE_COMPATIBILITY_PROVEN_FOR_MIMO=NO
MIMO_OPENAI_JSON_SCHEMA_WIRE_SUPPORT_AUTHORITY=INSUFFICIENT
MIMO_JSON_SCHEMA_WIRE_COMPATIBILITY_MAY_BE_ASSUMED=NO

AGENT_DECISION_LOCAL_STRICT_VALIDATION_REQUIRED=YES
UNKNOWN_DECISION_TYPE_REJECTED=YES
UNKNOWN_STRUCTURE_REJECTED=YES
MALFORMED_RESPONSE_FAIL_CLOSED=YES
MACHINE_READABLE_PROVIDER_FAILURE_CODE_COUNT=10
NO_NEW_MIMO_FAILURE_CODES=YES
FROZEN_PROVIDER_FAILURE_CODES=AGENT_PROVIDER_CONFIGURATION_MISSING,AGENT_PROVIDER_CONFIGURATION_INVALID,AGENT_PROVIDER_CREDENTIAL_INVALID,AGENT_PROVIDER_TIMEOUT,AGENT_PROVIDER_CONNECTION_FAILED,AGENT_PROVIDER_RATE_LIMITED,AGENT_PROVIDER_UPSTREAM_5XX,AGENT_PROVIDER_RESPONSE_MALFORMED,AGENT_PROVIDER_RESPONSE_TOO_LARGE,AGENT_PROVIDER_UNAVAILABLE

NEXT_IMPLEMENTATION_CORRECTION_WIRE_TEST_REQUIRED=YES
WIRE_LEVEL_TEST_OPENAI_SDK_VERSION=2.53.0
WIRE_LEVEL_TEST_TRANSPORT=mocked/injected HTTP transport
WIRE_LEVEL_TEST_INSPECTS_SERIALIZED_REQUEST_BODY=YES
WIRE_LEVEL_TEST_MUST_NOT_ONLY_MOCK_RESPONSES_PARSE=YES
WIRE_LEVEL_TEST_BASE_URL=https://api.xiaomimimo.com/v1
WIRE_LEVEL_TEST_ENDPOINT=/responses
WIRE_LEVEL_TEST_MODEL=mimo-v2.5
WIRE_LEVEL_TEST_STORE=false
WIRE_LEVEL_TEST_REASONING_EFFORT=none
WIRE_LEVEL_TEST_BACKGROUND_FIELD=ABSENT
WIRE_LEVEL_TEST_CONVERSATION_FIELD=ABSENT
WIRE_LEVEL_TEST_PREVIOUS_RESPONSE_ID_FIELD=ABSENT
WIRE_LEVEL_TEST_CONTEXT_MANAGEMENT_FIELD=ABSENT
WIRE_LEVEL_TEST_LIVE_NETWORK_CALL=NO
WIRE_LEVEL_TEST_PAYG_SK_CREDENTIAL_PATH_REQUIRED=YES
WIRE_LEVEL_TEST_TOKEN_PLAN_REJECTION_BEFORE_TRANSPORT_REQUIRED=YES
WIRE_LEVEL_TEST_STRICT_AGENT_DECISION_LOCAL_DECODING_REQUIRED=YES

P2_IMPLEMENTATION_EXECUTED=NO
IMPLEMENTATION_CODE_MUTATION=NO
TEST_MUTATION=NO
DEPENDENCY_MUTATION=NO
WORKFLOW_MUTATION=NO
LIVE_MIMO_API_CALL=NO
REAL_CREDENTIAL_MUTATION=NO
PRODUCTION_ENABLEMENT=NO
PR_133_MUTATION=NO
READY_AUTHORIZED=NO
MERGE_AUTHORIZED=NO
