...
V17_IMPLEMENTATION_AUTHORIZED=NO
V17_P0_IMPLEMENTATION_AUTHORIZED=NO
...
`V17_IMPLEMENTATION_AUTHORIZED=NO`：本文件冻结「1.7 核对什么」。未授权改代码。
打标签 `v1.7.0` 仍等实现授权且 **main HEAD CI 全绿** 后。不移动 `v1.6.0`。
