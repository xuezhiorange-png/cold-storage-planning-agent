...
`50210aa7cc876ed8a93a099c82ef4a4f287da82a`。当前已授权的 P2A 只提供确定性
site geometry foundation；历史 P1F、P1E 及更早状态块保留为历史快照。
...
新增证据见 `docs/tasks/V2_2-P2A-site-geometry-foundation.md`。本轮不改生产
计算、P1 handoff、MCP、前端、数据库或发布状态；P2A 也不代表完整布局可行。
