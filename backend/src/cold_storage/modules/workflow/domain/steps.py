...
WORKFLOW_CONTRACT_VERSION = "WorkflowAggregateV2"

OPERATOR_PROCESS_INPUT_STEP = "OPERATOR_PROCESS_INPUT"
...
STEP_OPERATOR_LABELS: dict[str, str] = {
    OPERATOR_PROCESS_INPUT_STEP: "工程输入",
}

STEP_NEXT_ACTION_LABELS: dict[str, str] = {
    OPERATOR_PROCESS_INPUT_STEP: "完成工程输入",
}
