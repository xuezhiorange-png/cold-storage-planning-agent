...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("ocr_engine_version", sa.String(100), nullable=False, server_default=""),
        ...
        sa.Column("review_status", sa.String(50), nullable=False, server_default="unverified"),
        sa.Column("warnings", _json_type(), nullable=False, server_default="[]"),
        sa.Column("errors", _json_type(), nullable=False, server_default="[]"),
        sa.Column("ingestion_run_id", sa.String(36), nullable=True),
        sa.Column("ingestion_provenance", _json_type(), nullable=False, server_default="{}"),
...
def downgrade() -> None:
    ...
    if op.get_bind().dialect.name == "sqlite":
        with op.batch_alter_table(CHUNKS_TABLE, recreate="always") as batch_op:
            ...
            batch_op.drop_column("is_ocr_derived")
        ...
        op.drop_column(CHUNKS_TABLE, "is_ocr_derived")
        op.drop_column(CHUNKS_TABLE, "requires_review")
