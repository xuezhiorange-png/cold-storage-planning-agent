"""V0.7 P3B public production-scheme API integration tests (PostgreSQL)."""
...
from tests.integration.test_production_scheme_postgresql import (
    WEIGHT_REVISION_ID,
...
if os.environ.get("DATABASE_BACKEND") != "postgresql":
    pytest.skip(
        "P3B PostgreSQL integration tests require DATABASE_BACKEND=postgresql",
...
def p3b_client(
    ...
    _seed_report_templates(pg_engine)
